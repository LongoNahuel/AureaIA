...
class Analyzer(ABC):
    ...
    def close(self) -> None:  # noqa: B027 - hook opcional, no abstracto a proposito
        ...
        queda vivo hasta el GC, y los destructores nativos corriendo recien
        al cierre del interprete pueden crashear el proceso en entornos
        headless (visto en CI). Los analizadores sin recursos nativos
        (MOG2, puerta) no necesitan implementarlo."""
